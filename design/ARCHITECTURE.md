...
agentic-obs is an MCP (Model Context Protocol) server that bridges AI assistants with OBS Studio. It provides 91 tools, 4 resource types, and 14 prompts for programmatic OBS control.

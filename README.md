...
**Total: 94 tools in 10 groups** (Core, Sources, Audio, Layout, Visual, Design, Filters, Transitions, Automation, AdvancedSceneSwitcher) + Meta (4 always-enabled tools)
...
├── internal/
│   ├── mcp/               # MCP server implementation (94 tools)
